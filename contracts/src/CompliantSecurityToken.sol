...
contract CompliantSecurityToken is ERC20, ERC20Permit, Pausable, Roles {
    ...
    function mintPartition(bytes32 p, address to, uint256 amount) external onlyAdmin whenNotPaused {
    ...
    function forceTransfer(bytes32 p, address from, address to, uint256 amount) external whenNotPaused {
